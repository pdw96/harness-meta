...
# ============================================================
# Stage 2: AGENTS.md.tmpl 14 sed 변수 + description placeholder + N17 README 관계 + footer link + license placeholder (v1.10b 그대로)
# ============================================================
...
# ============================================================
# Stage 4: AGENTS.md.tmpl sed 치환 mock (14 변수, install_cmd 치환, license placeholder 그대로, bootstrap_version stamp)
# ============================================================
TMP="$(mktemp)"
