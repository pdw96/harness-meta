...
- v6.6 audit chain hallucination 자동 검출: [`../development/WORKFLOW.md`](../development/WORKFLOW.md) § 1 매트릭스 #10 row
- v5.13 fact 인용 검증 절차: [`../development/WORKFLOW.md`](../development/WORKFLOW.md) § 1 매트릭스 #5 row
- v5.16 markdown lint precheck: [`../development/WORKFLOW.md`](../development/WORKFLOW.md) § 1 끝 'Agent 산출 markdown lint precheck 의무'
