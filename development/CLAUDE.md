...
- milestone 산출물 (v8.1+ 4-section-lightweight, **작은 건** 트랙): `milestones/v{X.Y}/LIGHTWEIGHT.md` (단일 본책, H2 4 섹션 = ## 문제 / ## 결정 / ## 적용 / ## 기록). 가벼운 흐름 = 내부·작은 조정 전용 (컨설팅 자산 영향 큰 건은 9-stage). skill = [`../skills/lightweight-flow/`](../skills/lightweight-flow/SKILL.md). 정의 + 승격 기준 1차 source: [`ARCHITECTURE.md`](ARCHITECTURE.md) § 7.4.
