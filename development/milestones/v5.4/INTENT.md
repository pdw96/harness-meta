...
v5.3 PROPOSE에서 optional candidate로 등재. marketplace.json plugins[0].source = './' 는 기능상 정상이나, spec 관점에서 외부 방문자에게 GitHub source 객체가 더 명시적일 수 있다는 개선 가능성 제기. 실제 전환 필요 여부는 RESEARCH spec 검증 후 결정.
