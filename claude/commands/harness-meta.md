...
| **S2 인터뷰** | `~/harness-meta/bootstrap/interview.md` | 코어 7 + 옵션 manifest 3 + 자유 3 = 13 질문 + 자동 7 (manifest 4 + AGENTS.md 콘텐츠 3: bootstrap_version v1.10b + install_cmd PM 매핑 v1.10c + license 3-tier v1.10e/e2 — T1 SPDX + T2-Multi dual + T2 boilerplate 12 패턴). 한 번에 표시·답변 |
