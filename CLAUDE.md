...
- 최신 meta 세션: @sessions/meta/v1.10e3-license-metadata/PLAN.md (LICENSE 메타데이터 4 source — pyproject PEP 639/621/poetry + npm + Cargo, T2.5 license-file 보강 + UNLICENSED 정규화 + SEE LICENSE IN 1회 재귀, OSS recovery 70% → 100% sample 30)
