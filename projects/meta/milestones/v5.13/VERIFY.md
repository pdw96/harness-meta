  ...
  "smoke_tests": [
    {
      ...
      "result": "PASS",
      "output": "fix end of files / trim trailing whitespace / check merge conflicts / check yaml / check large files / shellcheck / markdownlint / 7 smoke scripts — 모두 PASS 또는 Skipped (no files to check). 회귀 0."
    }
  ],
  "manual_checks": [
    {
      "check": "VERIFY grep keyword 1: 'fact 직접 검증' in claude/commands/harness-meta.md",
      "result": "PASS",
      "notes": "L80 — [synthesizer] audit chain 산출물 fact 직접 검증 step 정확 삽입 확인"
    },
    {
      "check": "VERIFY grep keyword 2: 'Audit chain fact 인용 검증 의무' in agents/project-harness-audit-team/CLAUDE.md",
      "result": "PASS",
      "notes": "L68 — Note (v5.13) 안 정의 단일 source 참조 확인"
    },
    {
      "check": "VERIFY grep keyword 3: 'v5.13' in projects/meta/ARCHITECTURE.md",
      "result": "PASS",
      "notes": "L137 — 절차화 (v5.13) cross-ref append 확인"
    }
  ],
  "criteria_check": [
    {
