  ...
  "decisions": [
    {
      ...
      "alternatives_rejected": [
        "O2 — agent runtime 본질 인식 부족",
        "O3 — 검증 method 분리 부재 = L7 lesson 미흡수"
      ]
    },
    {
      "id": "D2",
      ...
      "alternatives_rejected": [
        "다중 paragraph narrative — context overhead 증가 + 중복 위험",
        "external link 만 — agent runtime 시 자체 인식 부족"
      ]
    },
    {
      "id": "D3",
      ...
      "alternatives_rejected": [
        "project-scanner 변경 부재 — 4 멤버 일관성 narrative 부재 시 cross-ref 모호"
      ]
    },
    {
      "id": "D4",
      ...
      "alternatives_rejected": [
        "한 위치만 변경 — narrative drift 잠재 위험 (3-layer 부합도 약화)"
      ]
    },
    {
      "id": "D5",
      ...
      "alternatives_rejected": [
        "paragraph 본문 재작성 — v5.11 정전화 narrative drift risk"
      ]
    },
    {
      "id": "D6",
      ...
      "alternatives_rejected": [
        "2 phase 분할 (agent .md vs 절차 정전화) — narrative 분기 부재 시 단일 본질 자연 위반"
      ]
    },
    {
      "id": "D7",
      ...
      "alternatives_rejected": [
        "(a) phase-1 commit 안 포함 — phase-1 commit 안 산출물 + 구현 혼재 narrative 부합도 약화",
        "(c) 별도 commit — 1-phase 1+1 패턴 위반"
      ]
    },
    {
      "id": "D8",
      ...
      "alternatives_rejected": [
        "cycle 미카운팅 — 도그푸드 narrative 부합도 자연 위반"
      ]
    },
    {
      "id": "D9",
      ...
      "alternatives_rejected": [
        "memory 변경 부재 — cycle 누적 narrative stale 잔존"
      ]
    },
    {
      "id": "D10",
      ...
      "alternatives_rejected": [
        "component-proposer frontmatter tools 추가 Read — INTENT.out_of_scope #1 위반",
        "narrative 단일 패턴 (Read tool 의무) — proposer Write 만 충돌 위반"
      ]
    },
    {
      "id": "D11",
      ...
      "alternatives_rejected": [
        "v5.13 Note 안 v5.18 sub-narrative 중첩 — audit trail 가독성 약화"
      ]
    }
  ],
  "phases": [
    {
      ...
      "risks": [
        "R1 context overhead",
        "R2 v5.13 baseline 변경",
        "R3 § 4 끝 paragraph 본문 변경",
        "R7 narrative 중복"
      ]
    }
  ]
