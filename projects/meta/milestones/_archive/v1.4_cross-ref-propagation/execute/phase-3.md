...
```json
{
  ...
  "rewrite_plan": {
    ...
    "section_4": "Scope contract 의무 — 4-tier S#/T#/sessions verbatim 거명 제거. 7-stage 정합 (INTENT.md 의무 3 필드: success_criteria / out_of_scope / dependencies + DESIGN.approval gate)",
