...
```json
{
  ...
  "approval": {
    ...
    "perspectives_reviewed": ["architecture (Plan agent)", "scope-contract (Explore agent)", "regression-risk (Explore agent)"],
    "perspectives_skipped": ["spec-drift (RESEARCH ext_1~ext_3 안 검증)", "security (side effect 부재)"],
    "decisive_absorbed": 2,
    "p1_absorbed": 13,
    "p2_for_future": 15
  }
