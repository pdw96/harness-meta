# v3.18 — option-a-natural-adaptation-narrative
...
v3.17_phase-distribution-audit PROPOSE.next_candidates Option A 직접 후속. 사용자 명시 발의 (A_user trigger).

placeholder title 허용 narrative: OPEN 시점 정확한 phase 분할 미확정 — phase-1 title placeholder 허용, Stage D DESIGN 단계에서 `phases[]` 확정 후 `sub_milestones` 1:1 동기 갱신.
